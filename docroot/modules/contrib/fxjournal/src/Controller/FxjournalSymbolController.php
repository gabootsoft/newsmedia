...
/**
 * Returns responses for Forex Journal Trade Account routes.
 */
class FxjournalSymbolController extends ControllerBase {
  ...
  public function access(AccountInterface $user) {
    return AccessResult::allowedIf(
      $user->hasPermission('view forex journal symbol') &&
  ...
  public function dashboard(AccountInterface $user, Request $request) {
    return [
      'content' => $this->typeManager->getListBuilder('fxjournal_symbol')->render(),
    ];
  }
