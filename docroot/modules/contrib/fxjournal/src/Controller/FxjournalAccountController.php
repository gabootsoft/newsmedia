...
/**
 * Returns responses for Forex Journal  Account routes.
 */
class FxjournalAccountController extends ControllerBase {
  ...
  public function access(AccountInterface $user) {
    return AccessResult::allowedIf(
      $user->hasPermission('view forex journal account') &&
  ...
  public function dashboard(AccountInterface $user, Request $request) {
    return [
      'content' => $this->typeManager->getListBuilder('fxjournal_account')->render(),
    ];
  }
