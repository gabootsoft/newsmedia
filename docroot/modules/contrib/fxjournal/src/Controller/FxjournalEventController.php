 ...
 */
class FxjournalEventController extends ControllerBase {
  ...
  public function access(AccountInterface $user) {
    return AccessResult::allowedIf(
      $user->hasPermission('view forex journal event') &&
  ...
  public function dashboard(AccountInterface $user, Request $request) {
    return [
      'content' => $this->typeManager->getListBuilder('fxjournal_event')->render(),
    ];
  }
